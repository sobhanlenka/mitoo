from mitoo.storage import StorageAdapter


def get_response_table(response):
    from mitoo.ext.sqlalchemy_app.models import Response
    return Response(text=response.text, occurrence=response.occurrence)


class SQLStorageAdapter(StorageAdapter):
    """
    SQLStorageAdapter allows mitoo to store conversation
    ...
    def __init__(self, **kwargs):
        ...
        # mitoo's internal query builder is not yet supported for this adapter
    ...
    def get_statement_model(self):
        ...
        """
        from mitoo.ext.sqlalchemy_app.models import Statement
        return Statement
    ...
    def get_conversation_model(self):
        ...
        """
        from mitoo.ext.sqlalchemy_app.models import Conversation
        return Conversation
    ...
    def get_tag_model(self):
        ...
        Return the conversation model.
        """
        from mitoo.ext.sqlalchemy_app.models import Tag
        return Tag
    ...
    def drop(self):
        ...
        """
        from mitoo.ext.sqlalchemy_app.models import Base
