...
class Filter(object):
    ...
    def filter_selection(self, mitoo, conversation_id):
        """
        ...
        """
        return mitoo.storage.base_query
...
class RepetitiveResponseFilter(Filter):
    ...
    def filter_selection(self, mitoo, conversation_id):
        ...
        latest_response = mitoo.storage.get_latest_response(conversation_id)
        if latest_response:
        ...
        query = mitoo.storage.base_query.statement_text_not_in(
            text_of_recent_responses
        )
