...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'mitoo.storage.SQLStorageAdapter')

        # These are logic adapters that are required for normal operation
        system_logic_adapters = kwargs.get('system_logic_adapters', (
            'mitoo.logic.NoKnowledgeAdapter',
        ))

        logic_adapters = kwargs.get('logic_adapters', [
            'mitoo.logic.BestMatch'
        ])

        input_adapter = kwargs.get('input_adapter', 'mitoo.input.VariableInputTypeAdapter')

        output_adapter = kwargs.get('output_adapter', 'mitoo.output.OutputAdapter')
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'mitoo.preprocessors.clean_whitespace'
            ]
        )
        ...
        trainer = kwargs.get('trainer', 'mitoo.trainers.Trainer')
